...
function repetirMensaje() {
    ...
    // Mostrar el mensaje repetido en el div correspondiente
...
function encontrarMultiplos() {
    ...
    // Encontrar los múltiplos del número base hasta N
    let resultado = "";
    let i = 1;
    while (i <= numeroN) {
    ...
    // Mostrar los múltiplos en el div correspondiente
    let resultadoDiv = document.getElementById("resultado");
...
function encontrarPares() {
    ...
    // Encontrar los números pares hasta N
    let resultado = "";
    let i = 1;
    while (i <= numeroN) {
        if (i % 2 === 0) {
